...
<div class="container">
    ...
    <legend class="text-center">Detail de la voiture</legend >


        <form action="<?= base_url("index.php/Recepteur/insertDetailVoiture") ?>" method="post">
            ...
            <div class="row">
                ...
                <input class="col-lg-6" type="date" name="datevisite" id="">
            </div>
            <br/>
